"""loom_agent.opencode.process_manager — agentcli serve process lifecycle.
...
class AgentServerProcessManager:
    ...
    Sync::
        mgr = AgentServerProcessManager(data_dir=Path("./.loom"), base_port=4096)
    ...
    def get_or_create_api_session(self, key: str) -> str | None:
        ...
        try:
            ...
            title = f"Loom - {Path(proc.path).name}"
