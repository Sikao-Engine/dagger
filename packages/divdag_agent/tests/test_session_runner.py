...
import pytest
from divdag_agent import SessionRunner
from divdag_agent.backend import AgentEvent
from divdag_agent.backends.mock import MockBackend, MockScript
...
class TestKernelInvariants:
    def test_missing_status_rejected(self) -> None:
        from divdag_agent.contract import check_kernel_invariants
...
class TestTaskCard:
    def test_roundtrip(self) -> None:
        from divdag_agent.taskcard import TaskCard, render_task_card_prompt
