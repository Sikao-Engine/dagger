...
from loom_kernel.dag.instantiator import (
    ShardPlan,
    expand_dynamic,
    instantiate,
)
...
class TestContextMerge:
    ...
    def test_parallel_conflict_raises(self) -> None:
        from loom_kernel.dag import ContextConflictError, ContextPatch
    ...
    def test_apply_edge_map_renames_keys(self) -> None:
        from loom_kernel.dag import ContextPatch, apply_edge_map
