"""dagger_agent.opencode.process_manager — agentcli serve process lifecycle.
...
class AgentServerProcessManager:
    ...
    Sync::
        mgr = AgentServerProcessManager(data_dir=Path("./.dagger"), base_port=4096)
    ...
    def get_or_create_api_session(self, key: str) -> str | None:
        ...
        try:
            ...
            title = f"Dagger - {Path(proc.path).name}"
