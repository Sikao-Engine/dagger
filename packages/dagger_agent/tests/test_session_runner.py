...
import pytest
from dagger_agent import SessionRunner
from dagger_agent.backend import AgentEvent
from dagger_agent.backends.mock import MockBackend, MockScript
from dagger_agent.taskcard import TaskCard
...
class TestKernelInvariants:
    def test_missing_status_rejected(self) -> None:
        from dagger_agent.contract import check_kernel_invariants
...
class TestTaskCard:
    def test_roundtrip(self) -> None:
        from dagger_agent.taskcard import TaskCard, render_task_card_prompt
